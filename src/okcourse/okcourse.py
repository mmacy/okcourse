...
class AsyncOpenAICourseGenerator(CourseGenerator):
    ...
    async def generate_course_outline(self, topic: str) -> CourseGenerationResult:
    ...
    async def generate_course_lectures(self) -> CourseGenerationResult:
    ...
    async def generate_cover_image(self) -> CourseGenerationResult:
